...
실제 환경의 구성 및 H/W 사이징은 하기의 공식 문서를 따른다.
...
UDP를 통해 다량의 보안 장비 syslog데이터를 수집하는 경우,UDP 특성상 패킷 drop이 많이 발생할 수 있다. UDP라서 완전히 손실을 없애기는 힘들지만 다음과 같은 방법으로 손실을 거의 없앨 수 있다.
